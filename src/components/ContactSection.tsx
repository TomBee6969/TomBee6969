          ...
          <div className="bg-gradient-to-br from-graphite-grey/80 to-graphite-grey/40 backdrop-blur-sm p-8 rounded-3xl border border-platinum-silver/10 hover:border-champagne-gold/30 transition-all duration-300 group">
            ...
            <div className="space-y-6">
              <div className="flex items-center p-4 bg-deep-black/50 rounded-xl hover:bg-deep-black/70 transition-all duration-300 group/item">
                <div className="w-12 h-12 bg-gradient-to-br from-champagne-gold to-yellow-500 rounded-xl flex items-center justify-center mr-6 group-hover/item:scale-110 transition-transform duration-300">
                ...
                <div className="flex-1">
                  ...
                  <a 
                    ...
                    className="text-pearl-white font-semibold hover:text-champagne-gold transition-colors duration-300 text-lg"
                  >
                    +420 778 134 784
                  </a>
                </div>
              ...
              <div className="flex items-center p-4 bg-deep-black/50 rounded-xl hover:bg-deep-black/70 transition-all duration-300 group/item">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-pearl-white font-semibold text-lg">Uherské Hradiště</div>
                </div>
              </div>
            </div>
